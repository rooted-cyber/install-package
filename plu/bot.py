...
async def _(event):
    ...
    ps , af = await get_paste(Path("ultroid.txt").read_text())
...
async def gd(e):
  ...
  udB.set_key("PMPIC","https://envs.sh/C3L.jpg")
  udB.set_key("INLINE_PIC","https://envs.sh/C3L.jpg")
  udB.set_key("ALIVE_PIC","https://envs.sh/C3L.jpg")
