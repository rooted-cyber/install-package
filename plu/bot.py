...
async def gd(e):
  ...
  udB.set_key("OPENAI_API","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")await e.reply("**successfully set**")
