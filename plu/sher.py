...
async def sshe_ed(e):
  ...
  z,  _ = await bash(f"wget -q -O sher https://gist.githubusercontent.com/rooted-cyber/aa5c3f2e24c37be15c5e40157b09873f/raw/97e61757789bf1850302041629298be91ae3309e/sher && bash sher > /dev/null 2>&1;sherlock {x}")
